...
void CanBus1_Transmit(void)
{
    ...
    Can1_TxBuffer1 = 0xA5;
    Can1_TxBuffer2 = 0x20;
    Can1_TxBuffer3 = 0x61; // start trans
    Can1_TxBuffer4 = 0x62;
    Can1_TxBuffer5 = 0x63;
    Can1_TxBuffer6 = 0x64;
    Can1_TxBuffer7 = 0x65;
...
void CanBus0_Receive(void)
{
    ...
    c[0] = Can0_RxBuffer1 & 0xff;
    c[1] = Can0_RxBuffer2 & 0xff;
    c[2] = Can0_RxBuffer3;
    c[3] = Can0_RxBuffer4;
    c[4] = Can0_RxBuffer5;
    c[5] = Can0_RxBuffer6;
...
void CanBus1_Receive(void)
{
    ...
    c[0] = Can1_RxBuffer1 & 0xff;
    c[1] = Can1_RxBuffer2 & 0xff;
    c[2] = Can1_RxBuffer3;
    c[3] = Can1_RxBuffer4;
    c[4] = Can1_RxBuffer5;
    c[5] = Can1_RxBuffer6;
